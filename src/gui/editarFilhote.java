 ...
 * @author Jakson
 */
public class editarFilhote extends javax.swing.JDialog {
    private filhotes filhotes;
    Integer tatuagem;
    /**
     * Creates new form editarFilhote
     */
    public editarFilhote(java.awt.Frame parent, boolean modal, filhotes filhotes) {
        super(parent, modal);
        initComponents();
        this.filhotes = filhotes;
        
        filhotes.passar(this);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("                      Editar Filhote");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
               dao.updateFilhote(filhote, tatuagem);
               filhotes.reload();
               dispose();
            }catch(Exception ex){
               jLabel2.setForeground(Color.red);
               jLabel2.setText("Tatuagem já cadastrada.");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editarFilhote.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                editarFilhote dialog = new editarFilhote(new javax.swing.JFrame(), true, null);
    ...
    public void test(String str1,String str2,String str3){
        ...
        this.tatuagem = Integer.parseInt(str1);
    }
}
